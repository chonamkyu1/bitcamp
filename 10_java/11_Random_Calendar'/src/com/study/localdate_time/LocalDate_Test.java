package com.study.localdate_time;
...
public class LocalDate_Test {
	public static void main(String[] args) {
		// 전통적인 Calendar 사용: 값이 변경이된다.(Muttable)
		...
		System.out.println("nowLocalDate: " + newLocalDate);
		...
		System.out.println("초(나노값): " +nowTime.getNano());
		...
		System.out.println("초(나노값): " +nowDT.getNano());
