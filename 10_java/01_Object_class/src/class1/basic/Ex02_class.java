...
class Ex02_class {
	...
	public static void main(String[] args) {
		...
		System.out.println("rseult(add 연산결과) : " + result);
		...
		System.out.println("rseult(sub 연산결과) : " + result);
	...
	// 2개의 정수값을 전달받아 2개의 정수값을 더한 결과를 되돌려준다(return)
	public static int add(int a, int b) {
		return a + b;
	}
	
	// 2개의 정수값을 전달받아 첫번째 값에서 두번째 값을 뺀 결과를 되돌려준다(return)
