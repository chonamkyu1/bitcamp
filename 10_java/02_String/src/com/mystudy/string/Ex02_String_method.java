...
public class Ex02_String_method {
	...
	public static void main(String[] args) {
		...
		// char[] ch2 = {str.charAt(0), str.charAt(1),
		...
		String str3 = String.copyValueOf(ch3); // 형변환 char에서 String로
		System.out.println("copyValueOf(ch3) : " + str3);
		System.out.println("copyValueOf(ch3,0,2) : " + String.copyValueOf(ch3, 0, 2));

		// 시작 문자열 여부 확인
		System.out.println("----- starstWith() -----");
		...
		System.out.println("str4.indexOf('a') : " + str4.lastIndexOf('a'));
		System.out.println("str4.indexOf(\"a\") : " + str4.lastIndexOf("a"));
		...
		System.out.println("-----substring() -----"); // 문자열 특정부분을 잘라서씀
		// 0123456789 : 길이 10
		str = "Java World";
		System.out.println("str : " + str);
		...
		System.out.println("-----toUppserCase(), toLoserCase(), trim()------");
		str = "        Java World       ";
		System.out.println("str : -" + str + "-");
