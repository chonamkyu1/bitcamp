...
public class CarTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("====== 형변환 후 ============");
		 ...
		 // Car 타입이기 때문에 구급차의 사이렌 기능을 사용 못한다.
		 // 구급차의 사이렌 기능을 사용하려면 구급차가 되어야한다.
		 //carTemp.siren(); // 컴파일 오류 : the method siren() is undefined for the type Car  
		 ...
		 if(carTemp instanceof Ambulance) {  //carTemp에 무엇이 담겼는지에 따라 출력값이 다르다.
