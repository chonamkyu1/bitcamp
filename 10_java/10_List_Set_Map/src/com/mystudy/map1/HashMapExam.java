...
public class HashMapExam {
	public static void main(String[] args) {
		...
		// - 순서가 없다.
		// - 키(key): 중복 안된다.(중복값 없이 유일한 데이터)
		// - 값(value): 중복 데이터 저강 가능하다.
		// -----------------------------------------
		...
		System.out.println(map.put("홍길동", 93)); // 동일한 key가 있으면 수정처리가 된다.
		...
		// ----------------------------------
		System.out.println("--- 갑(value) 추출: values() 시용 ----");
		...
		System.out.println("---- entrtSet() 사용 ----");
