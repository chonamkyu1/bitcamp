...
// 형태상 파이프모양 (선입선출: FIFO - First In First Out)
// ---------------
// 스택(Stack) 클래스 
...
public class Stack_Queue {
	public static void main(String[] args) {
		...
		// peek(): 데이터를 확인만한다. 꺼내지는 않는다.(참조/조회)
		...
		while (!queue.isEmpty())	{ //비어있지않으면 while문은 true값만 작동한다.
		...
		System.out.println("---- peek() ----");
		System.out.println("stack.peet: " + stack.peek());
		System.out.println("stack.peet: " + stack.peek());
		System.out.println(stack);
		System.out.println();
...
//		System.out.println(stack.pop());
//		System.out.println(stack.pop());
		//System.out.println(stack.pop());  // 없으면 오류
		System.out.println(stack);
		System.out.println("stack.size(): " + stack.size());


		
		System.out.println("--- 스택의 전체 데이터 추출 ---");
		while (!stack.isEmpty()) {
			System.out.println(stack.pop());
		}
		System.out.println("stack.size(): " + stack.size());
