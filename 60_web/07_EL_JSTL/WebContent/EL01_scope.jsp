...
<%-- EL(Expression Language): 표현언어
	...
	2. 사용할 데이터가 반드시 scope 상에 존재해야 한다.
		...
		해당 scope 상에 setAttribute 설정된 변수(속성) 값만 사용 가능하다.
		(주의: 로컬변수에 있는 데이터는 사용하지 못한다.)
	3. 같은 이름이 다른 scope 상에 존재하는 경우 접근 우선순위가 적용된다.
 ...
 --%>
	...
	<%-- =========================================== --%>
	<h2>동일한 이름의 속성명이 여러 scope상에 존재할 떄</h2>
<%
