...
<script>
	...
	function sessionRemove() {
		location.href = "ex01.sessionRemove.jsp";
	}
	function sessionInvalidate() {
		location.href = "ex01.sessionInvalidate.jsp";
	}
</script>
</head>
<body>
	...
	<input type="button" value="세선 속성 삭제" onclick="sessionRemove()">
	<input type="button" value="세선 초기화(무효화)" onclick="sessionInvalidate()">
	<hr><hr>
