...
<script>
	...
	function getXmlMembers(){
		...
		//location.href = "getDataBtn";
				
		$.ajax({
			url : "getXmlMembers",  //@WebSevlet랑 연결
			type: "get",
			//data: "name=" + name + "&age=" + age;
			//data: $("#inputForm").serialize(); // form 데이터 파라미터 값 전달
			dataType: "xml", // 응답받을 데이터 타입 지정 , 응답결과의 데이터 형태
			success: function(data){
				alert("Ajax 처리 성공 - 응답받은데이터: " + data)
				console.log(data);
