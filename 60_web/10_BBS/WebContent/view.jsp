...
<%
	...
	// 1. 게시글 조회수 1 증가 (실습)
	int updateIdx = DAO.update(Integer.parseInt(b_idx));
	pageContext.setAttribute("updateIdx", updateIdx);
	...
	// 3. 게시글(b_idx)에 딸린 댓글 있으면 가져오기
	List<CommentVO> list = DAO.getCommentList(bIdx);
