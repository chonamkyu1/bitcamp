...
SELECT SUBSTR('홍길동123', -3) FROM DUAL; -- 123
SELECT SUBSTR('홍길동123', -3, 3) FROM DUAL; -- 123: 뒤에서 3개
...
--INSTR(대상, 찾는문자, 시작위치)
--INSTR(대상, 찾는문자, 시작위치, nth) : nth 찾은값의 순서값(3 : 3번째 찾은 값)
SELECT INSTR('900101-1234567', '-') FROM DUAL; -- 7번째 위치값 리턴된다.
SELECT INSTR('900101-1234567', '*') FROM DUAL; -- 0을 리턴: 없을 때
SELECT INSTR('900101-1234567', '34') FROM DUAL; -- 10
SELECT INSTR('900101-1234567', '1' , '7') FROM DUAL; -- 8리턴: 7번째 위치부터 찾는다.
SELECT INSTR('900101-1234567', '1' , 1, 2) FROM DUAL; -- 6리턴: 처음부터 찾고 2번째 찾은 위치
