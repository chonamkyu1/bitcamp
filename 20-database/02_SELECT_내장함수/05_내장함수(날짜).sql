...
MONTHS_BETEEN(날짜1, 날짜2): 기간 구하기(개월) 연산방식(날짜1 - 날짜2)
*/
...
SELECT MONTHS_BETWEEN(ADD_MONTHS(SYSDATE-15, 2), SYSDATE) FROM DUAL;
...
SELECT SYSDATE, TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS')
    , TO_CHAR(SYSDATE+1, 'YYYY-MM-DD HH24:MI:SS') -- 일 더하기
    , TO_CHAR(SYSDATE+(1/24), 'YYYY-MM-DD HH24:MI:SS') -- 시간더하기
    , TO_CHAR(SYSDATE+(1/24)*5, 'YYYY-MM-DD HH24:MI:SS') -- 시간더하기
FROM DUAL;
