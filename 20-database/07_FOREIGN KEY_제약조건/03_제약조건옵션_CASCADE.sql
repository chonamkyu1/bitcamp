...
-- 부모테이블 데이터 삭제 - 다른 테이블에서 참고하고 있으면 삭제 불가능하다.
...
----     참조하고 있는 테이블 EMP01, EMP02, EMP03 함께 비활성화 처리한다.
----     CASCADE 옵션 사용: 부모테이블 PK + 자녀테이블 FK 동시에 비활성화 처리
ALTER TABLE DEPT DISABLE PRIMARY KEY CASCADE; 
-- DELETE FROM DEPT WHERE ID = 10;  

--===============================================
 /* 제약조건 옵션: ON DELETE CASDADE 
...
INSERT INTO C_TEST_SUB VALUES(1, '1번 SUB데이터', 1111);
INSERT INTO C_TEST_SUB VALUES(2, '2번 SUB데이터', 2222);
INSERT INTO C_TEST_SUB VALUES(3, '3번 SUB데이터', 3333);
INSERT INTO C_TEST_SUB VALUES(4, '4번 SUB데이터', 3333);
COMMIT;
...
---- FK 비활성화(DISABLE) 설정으로는 안된다. FK 삭제해야만 한다.
